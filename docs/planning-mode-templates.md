...
On-demand reference for R&D **planning modes** and plan-file templates. Planning skills load this doc at **named protocol steps** — not on every warm-up.
