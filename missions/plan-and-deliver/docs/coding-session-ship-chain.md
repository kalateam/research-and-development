...
| `shipPhase` | `shipPhase` |
| `nextAction: promote-pin-required` | Hand off to inline **`promote-center-submodule-pin`** per [Post-merge Checkpoint chain](#post-merge-checkpoint-chain-binding) — use `centerPinDriftPaths` for scope |
