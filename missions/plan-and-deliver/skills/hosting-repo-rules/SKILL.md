...
| Path | Purpose |
|------|---------|
| `.sedea/centers/research-and-development/missions/plan-and-deliver/skills/README.md` | Slim spawn contracts, terminal stop, parallel fork |
...
| Path | Load when |
|------|-----------|
| `.sedea/centers/research-and-development/missions/plan-and-deliver/docs/spawn-ship-contracts.md` | Before merging child terminals, parallel hosting-repo-rules fork, or MCP notify preflight N1-N8 detail |
