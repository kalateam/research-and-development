...
## research-and-development center edit destination gate (binding)
...
USER_CHECKPOINT — pick research-and-development center edit destination before any center write.
...
| `delegate-base-rd` | Delegate to base center — `sedea-centers/software-development` | **Stop** local center writes; developer continues on **`sedea-centers-development-hosting-repo`** for **general** research-and-development center operating-model changes |
...
## Definitive `bootstrapRules` (R&D center layer — plan and deliver)
